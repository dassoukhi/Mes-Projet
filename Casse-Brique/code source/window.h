...
Color inttoCol(int n); // fonction qui convertit un entier en couleur
...
class Window {
 ...
 public:
  ...
  //void print(int x, int y, std::string s, Couleur c) const;
  ...
  char getBord() const ;   // récupère le caractère composant la fenêtre
